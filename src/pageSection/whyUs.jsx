...
const servicesData = [
  {
    ...
    description: "Stay connected with high-speed internet and AI-powered services from Primelink.",
...
export default function OurServices() {
  ...
  return (
    ...
    <div id="our-services" className="w-full bg-white font-poppins px-6 pt-10 pb-20 mt-20">
      ...
      <div className="max-w-[1300px] mx-auto flex flex-col lg:flex-row items-start justify-between gap-10 px-4 lg:px-12 bg-white">
        ...
        <div className="w-full lg:w-[55%] space-y-8 bg-white">
          <h2 className="text-5xl font-bold text-[#0B1F47] leading-tight">
            Laya<span className="text-[#3B82F6]">na</span>n Kami
          </h2>
          ...
          >
            <div className="flex items-start gap-5">
              ...
              />
              <div>
                <p className="text-sm opacity-80">{currentService.description}</p>
                <h3 className="font-bold text-xl mt-2">{currentService.title}</h3>
        ...
        <div className="w-full lg:w-[45%] text-[#0B1F47] space-y-6 bg-white">
          <p className="text-4xl sm:text-5xl font-semibold leading-snug">
            ...
            stabil, dan tanpa <span className="text-[#3B82F6]">drama</span> —<br />
          ...
          <p className="text-sm leading-relaxed max-w-md">
            Primelink menghadirkan solusi konektivitas digital yang cerdas dan andal, 
            dirancang khusus untuk kebutuhan rumah maupun bisnis —
          </p>
        </div>
      </div>
    </div>
